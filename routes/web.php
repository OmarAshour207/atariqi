...
Route::middleware(['is_admin'])->prefix('dashboard')->group(function () {
    ...
    Route::get('general-dues-percentage', [GeneralDuesPercentageController::class, 'show'])->name('general-dues-percentage.show');
    Route::patch('general-dues-percentage', [GeneralDuesPercentageController::class, 'update'])->name('general-dues-percentage.update');
    ...
    Route::post('passengers/profile-updates/{newUserInfo}/approve', [PassengerController::class, 'approveProfileUpdate'])->name('passengers.approve-profile-update');
    Route::post('passengers/profile-updates/{newUserInfo}/reject', [PassengerController::class, 'rejectProfileUpdate'])->name('passengers.reject-profile-update');

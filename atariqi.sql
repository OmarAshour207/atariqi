...
INSERT INTO `drivers-schedule` (`id`, `driver-id`, `Saturday-to`, `Saturday-from`, `Sunday-to`, `Sunday-from`, `Monday-to`, `Monday-from`, `Tuesday-to`, `Tuesday-from`, `Wednesday-to`, `Wednesday-from`, `Thursday-to`, `Thursday-from`, `date-of-add`, `date-of-edit`) VALUES
	(1, 2, '21:00:00', '14:00:00', '08:00:00', '14:00:00', '22:00:00', '15:00:00', '00:34:00', '13:00:00', '20:30:00', '13:00:00', '20:30:00', '22:00:00', '2023-08-16 17:07:19', NULL);
...
-- Dumping data for table atariqi.migrations: ~49 rows (approximately)
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES
	...
	(48, '2023_10_01_140654_create_day_ride_bookings_table', 8),
	(49, '2023_10_01_144858_create_sug_day_drivers_table', 8),
	(50, '2023_10_01_211558_create_socials_table', 9),
	(51, '2023_10_01_214626_add_lat_and_lng_to_university_table', 10),
	(53, '2023_10_04_000110_add_passenger_id_to_sug_day_driver', 11),
	(54, '2023_10_04_230917_add_lat_and_lng_to_day_ride_booking_table', 12),
...
INSERT INTO `personal_access_tokens` (`id`, `tokenable_type`, `tokenable_id`, `name`, `token`, `abilities`, `last_used_at`, `created_at`, `updated_at`) VALUES
	...
	(3, 'App\\Models\\User', 4, 'atariqi', '01d97313f5469996d5236618bd2216c271bfa90d4cab0bc78cd744217cf05fdf', '["*"]', '2023-10-07 16:53:47', '2023-09-18 18:52:35', '2023-10-07 16:53:47'),
	(4, 'App\\Models\\User', 5, 'atariqi', '35e9861179dd61fbee3b5c2fb4d2e5fe4848add469aa13d3c5266d166e1bd1eb', '["*"]', NULL, '2023-09-26 23:12:05', '2023-09-26 23:12:05');
...
-- Dumping data for table atariqi.ride-booking: ~4 rows (approximately)
...
INSERT INTO `ride-booking` (`id`, `passenger-id`, `neighborhood-id`, `location`, `service-id`, `action`, `date-of-add`, `lat`, `lng`) VALUES
	(29, 1, 1, NULL, 1, 3, '2023-09-26 00:33:37', '123', '1234'),
	(30, 1, 1, NULL, 1, 0, '2023-09-26 00:45:33', '123', '1234'),
	(31, 1, 1, NULL, 1, 0, '2023-09-26 00:47:54', '123', '1234'),
...
CREATE TABLE IF NOT EXISTS `sug-day-drivers` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `driver-id` bigint(20) NOT NULL,
  `booking-id` bigint(20) unsigned NOT NULL,
  `action` tinyint(4) DEFAULT NULL,
  `date-of-add` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `date-of-edit` timestamp NULL DEFAULT NULL,
  `passenger-id` bigint(20) DEFAULT NULL,
  `viewed` tinyint(4) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `sug_day_drivers_driver_id_foreign` (`driver-id`),
  KEY `sug_day_drivers_booking_id_foreign` (`booking-id`),
  KEY `sug_day_drivers_passenger_id_foreign` (`passenger-id`),
  CONSTRAINT `sug_day_drivers_booking_id_foreign` FOREIGN KEY (`booking-id`) REFERENCES `day-ride-booking` (`id`) ON DELETE CASCADE,
  CONSTRAINT `sug_day_drivers_driver_id_foreign` FOREIGN KEY (`driver-id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
  CONSTRAINT `sug_day_drivers_passenger_id_foreign` FOREIGN KEY (`passenger-id`) REFERENCES `users` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table atariqi.sug-day-drivers: ~2 rows (approximately)
/*!40000 ALTER TABLE `sug-day-drivers` DISABLE KEYS */;
INSERT INTO `sug-day-drivers` (`id`, `driver-id`, `booking-id`, `action`, `date-of-add`, `date-of-edit`, `passenger-id`, `viewed`) VALUES
	(10, 2, 22, 0, '2023-10-06 20:50:46', NULL, 4, 0),
	(11, 2, 23, 0, '2023-10-06 20:51:44', NULL, 4, 0);
/*!40000 ALTER TABLE `sug-day-drivers` ENABLE KEYS */;
...
-- Dumping data for table atariqi.suggestions-drivers: ~2 rows (approximately)
/*!40000 ALTER TABLE `suggestions-drivers` DISABLE KEYS */;
INSERT INTO `suggestions-drivers` (`id`, `booking-id`, `driver-id`, `action`, `date-of-add`, `date-of-edit`) VALUES
	(1, 30, 2, 0, '2023-09-26 00:45:33', NULL),
	(2, 31, 2, 0, '2023-09-26 00:47:54', NULL);
...
-- Dumping data for table atariqi.uni-driving-services: ~4 rows (approximately)
...
INSERT INTO `uni-driving-services` (`id`, `university-id`, `service-id`, `date-of-add`) VALUES
	...
	(3, 2, 3, '2023-08-16 16:56:16'),
	(4, 1, 2, '2023-08-16 16:56:16'),

    ...
    <div class="mdk-drawer-layout__content page">
        ...
        <div class="container-fluid page__container">
            ...
            <div class="card card-form__body card-body">
                <form method="post" action="{{ route('homepage-stats.store') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input id="label" name="label" dir="auto" type="text" class="form-control" placeholder="{{ __("Label") }}" value="{{ old("label") }}">
                    </div>

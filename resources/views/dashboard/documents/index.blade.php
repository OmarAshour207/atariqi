        ...
        <div class="card table-responsive">
            <table class="table table-striped mb-0">
                ...
                @forelse($documents as $document)
                    ...
                    <div class="modal fade" id="replaceDoc{{ $document->id }}" tabindex="-1">
                        <div class="modal-dialog"><form method="POST" action="{{ route('documents.replace', $document) }}" enctype="multipart/form-data" class="modal-content">
                            @csrf
                            <div class="modal-header"><h5>{{ __('Replace Document') }}</h5><button type="button" class="close" data-dismiss="modal">&times;</button></div>
                            <div class="modal-body"><input type="file" name="file" accept="application/pdf" class="form-control" required></div>

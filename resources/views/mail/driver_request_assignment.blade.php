            ...
            <table width="620" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;border:1px solid #e5e7eb;">
                ...
                <tr>
                    <td style="padding:35px;color:#333333;line-height:1.8;">
                        ...
                        <p>
                            {{ __('A driver registration request has been assigned to you for review.') }}
                        </p>

                        <table width="100%" cellpadding="8" cellspacing="0" style="margin-top:20px;border:1px solid #e5e7eb;border-collapse:collapse;">
                            <tr style="background:#f8fafc;">
                                <td width="35%"><strong>{{ __('Driver') }}</strong></td>
                                <td>{{ $driver->{'user-first-name'} }} {{ $driver->{'user-last-name'} }} ({{ $driver->email }})</td>
                            </tr>
                        ...
                        <p style="margin-top:25px;">
                            {{ __('Please review the request in the dashboard.') }}
                        </p>
                ...
                <tr>
                    <td dir="rtl" style="padding:35px;text-align:right;color:#333333;line-height:2;font-family:Tahoma,Arial,sans-serif;">
                        ...
                        <p>
                            تم إسناد طلب تسجيل سائق جديد إليك لمراجعته واتخاذ الإجراء المناسب.
                        </p>

                        <table width="100%" cellpadding="8" cellspacing="0" style="margin-top:20px;border:1px solid #e5e7eb;border-collapse:collapse;text-align:right;">

<tr style="background:#f8fafc;">
                                <td width="35%"><strong>السائق</strong></td>
                                <td>{{ $driver->{'user-first-name'} }} {{ $driver->{'user-last-name'} }} ({{ $driver->email }})</td>
                            </tr>
                        ...
                        <p style="margin-top:25px;">
                            يرجى مراجعة الطلب من خلال لوحة التحكم واتخاذ الإجراء المناسب في أقرب وقت.
                        </p>
                ...
                <tr>
                    <td align="center" style="background:#f8fafc;padding:30px;border-top:1px solid #e5e7eb;">
                        ...
                        <p style="margin:0;color:#555555;font-size:15px;">
                            For any technical assistance, please contact our support team.
                        </p>

                        <p style="margin:10px 0 0;color:#555555;font-size:15px;">
                            لأي استفسارات أو دعم فني، يرجى التواصل مع فريق الدعم.
                        </p>

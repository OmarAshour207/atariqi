...
<head>
    <meta charset="UTF-8">
    <title>{{ __('Package Deletion Notification') }}</title>
</head>
            ...
            <table width="620" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;border:1px solid #e5e7eb;">
                ...
                <tr>
                    <td align="center" style="background:#0F5CC0;padding:35px 30px;">
                        <h1 style="margin:0;color:#ffffff;font-size:28px;font-weight:bold;">
                            {{ __('Package Deletion Notification') }}
                        </h1>
                ...
                <tr>
                    <td style="padding:35px;color:#333333;line-height:1.8;">
                        ...
                        <p>
                            {{ __('We would like to inform you that one of our packages has been removed. Here are the details of the deleted package:') }}
                        </p>
                        ...
                        <table width="100%" cellpadding="10" cellspacing="0" style="margin-top:20px;border:1px solid #e5e7eb;border-collapse:collapse;">
                            ...
                            <tr>
                                <td><strong>{{ __('Monthly Subscription') }}</strong></td>
                                <td>{{ $package->price_monthly }} SAR</td>
                            </tr>

                            <tr style="background:#f8fafc;">
                                <td><strong>{{ __('Annual Subscription') }}</strong></td>
                                <td>{{ $package->price_annual }} SAR</td>
                            </tr>

                        </table>

                        <p style="margin-top:25px;">
                            {{ __('Visit our platform to explore the available packages.') }}
                        </p>
                ...
                <tr>
                    <td dir="rtl" style="padding:35px;text-align:right;color:#333333;line-height:2;font-family:Tahoma,Arial,sans-serif;">
                        ...
                        <p>
                            نود إعلامكم بأنه تم حذف إحدى الباقات. فيما يلي تفاصيل الباقة المحذوفة:
                        </p>
                        ...
                        <table width="100%" cellpadding="10" cellspacing="0" style="margin-top:20px;border:1px solid #e5e7eb;border-collapse:collapse;text-align:right;">
                            ...
                            <tr>
                                <td><strong>الاشتراك الشهري</strong></td>
                                <td>{{ $package->price_monthly }} ريال سعودي</td>
                            </tr>

                            <tr style="background:#f8fafc;">
                                <td><strong>الاشتراك السنوي</strong></td>
                                <td>{{ $package->price_annual }} ريال سعودي</td>
                            </tr>

                        </table>

                        <p style="margin-top:25px;">
                            ندعوك لزيارة منصتنا للاطلاع على الباقات المتاحة.
                        </p>

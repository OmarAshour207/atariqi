...
use App\Models\Concerns\SnapshotsAtariqiPercentage;
...
{
    use HasFactory;
    use SnapshotsAtariqiPercentage;
    ...
    {
        $dates[0]['end_date'] = isset($dates[0]['end_date'])
            ? date('Y-m-d H:i:s', strtotime($dates[0]['end_date'] . ' 23:59:59'))
            : null;

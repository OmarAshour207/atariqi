...
class SuggestionDriverDetailsResource extends JsonResource
{
    public function toArray($request)
    {
        return [
            ...
            'destination_lat' => $this->{"road-way"} == 'from' ? $this->booking->lat : $this->booking->university->lat,
            'destination_lng' => $this->{"road-way"} == 'from' ? $this->booking->lat : $this->booking->university->lng
        ];
    }

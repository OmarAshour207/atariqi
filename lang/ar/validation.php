...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'user-last-name'        => 'اسم العائلة',
        'call-key-id'           => 'رمز الدوله',
        'university-id'         => 'الجامعة',
        'user-stage-id'         => 'وظيغه المستخدم',
        'approval'              => 'الموافقه',
        ...
        'car-letters'           => "لوحة السيارة (حروف)",
        'car-color'             => "لون السيارة",
        'car-number'            => "لوحة السيارة (الارقام)",
        'license_img'           => "صورة رخصة قيادة السيارة",
        'car_form_img'          => "صورة استمارة السيارة",
        'car_front_img'         => "صورة السيارة من الامام",
        'car_back_img'          => "صورة السيارة من الخلف",
        'car_rside_img'         => "صورة السيارة من اليمين",
